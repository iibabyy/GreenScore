...
export default function RotatingEarth({
  ...
  if (error) {
    return (
      <div
        className={`light flex items-center justify-center bg-card rounded-2xl p-8 ${className}`}
      >
        <div className="text-center">
          <p className="light text-destructive font-semibold mb-2">
            Error loading Earth visualization
          </p>
          <p className="light text-muted-foreground text-sm">{error}</p>
        </div>
      </div>
    );
  }
